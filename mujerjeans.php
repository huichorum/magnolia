...
<body>
  ...
  <img src="src/banner/banner_jeansmujeres.jpg" class="img-fluid" alt="...">
  <!--</div>-->
  <br><br>
  <div class="row">
    <div class="col-sm">
  ...
  <div id="color" class="container-fluid">
    ...
    <div class="container">
      <?php
      $cuenta = 0;
      $consulta = "SELECT IDropa,IDcategoria,Producto,Precio,Descripcion,Imagen FROM catalogo WHERE IDcategoria='MJS'";
