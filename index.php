...
<body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="src/banner/banner_incio1.jpg" class="d-block w-100" alt="..." width="700px" height="500px">
        </div>
        <div class="carousel-item">
          <img src="src/banner/banner_inicio2.jpg" class="d-block w-100" alt="..." width="700px" height="500px">
        </div>
        <div class="carousel-item">
          <img src="src/banner/banner_inicio3.jpg" class="d-block w-100" alt="..." width="700px" height="500px">
        </div>
      </div>
  ...
  <div class="row">
    <div class="col-sm">
      <b>
        <h1 id="letra_m">Ropa de mujer</h1>
      </b>
    </div>
  </div>
  <br><br>
  <div id="color" class="container-fluid">
    ...
    <div class="container">
      <?php
      $cuenta = 0;
      $consulta = "SELECT IDropa,IDcategoria,Producto,Precio,Descripcion,Imagen FROM catalogo WHERE IDropa IN ('MFV-100','MJS-200','MAC-300','MBPC-003','MSS-009','MFV-300')"; 
          ...
          <div class="col-sm-4">
            <div class="card" style="width: 18rem;">
              <form action="php/conexion.php" method="POST">
                ...
                <button id="btn" class="btn btn-primary" type="submit" name="agregar">Agregar al carrito</button>
              </form>
            </div>
          </div>
          <?php
  ...
  <div class="row">
    <div class="col-sm">
      <b>
        <h1 id="letra_h">Ropa de hombre</h1>
      </b>
    </div>
  </div>
  <br><br>
  <div id="color_h" class="container-fluid">
    ...
    <div class="container">
      <?php
      $cuenta = 0;
      $consulta = "SELECT IDropa,IDcategoria,Producto,Precio,Descripcion,Imagen FROM catalogo WHERE IDropa IN('HAC-100','HPS-600','HSS-300','PML-500','HPS-200','PML-100')";
      $query = mysqli_query($conexion, $consulta);
      while ($row = mysqli_fetch_assoc($query)) {
        if ($cuenta == 0) { ?>
          <div class="row">
